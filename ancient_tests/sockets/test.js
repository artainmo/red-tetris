...
async function test() {
	...
	if (process.argv.length > 2 && process.argv[2] === 'piece') {
		...
		console.log(
			'Alfred asks for a new piece that should be send to all room members'
		)
