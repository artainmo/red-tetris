...
import { createMultiGame, gameStart, joinMultiGame } from '../../api/http.api';
...
export const leaveRoomThunk = createAsyncThunk(
	...
	({ username, userSocket, roomName }, { rejectWithValue }) => {
		try {
			...
			return rejectWithValue(err.message || "Unknown error occurred while leaving room");
		}
	}
);
...
export const { setPlayers, setRoomId, playerLeft, playerJoined, gameStarted, setNewHost } = roomSlice.actions;
